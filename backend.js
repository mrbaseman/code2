    ...
    switch (lang) {
        case 'DE':
            switch(whatis) {
                ...
                case '2':
                case '7':
                     t = "Javascript: <span class='info_not'>"
                ...
                case '8':
                case '3':
                     t = "Interner Kommentar: erscheint nicht auf der Website.";
                    break;
                case '9':
                case '4':
                     t = "<font color='#990000'>"
        ...
        case 'FR':
            switch(whatis) {
                case '6':
                case '1':
                    t = "HTML: <b> votre entr&eacute;e </b>";
                    break;
                case '7':
                case '2':
                    t = "Javascript: <span class='info_not'>"
                ...
                case '8':
                case '3':
                    t = "Commentaire interne: pour les notes internes uniquement, "
        ...
        case 'IT':
            switch(whatis) {
                ...
                case '8':
                case '3':
                    t = "Commento interna: per le note interne solo, "
        ...
        default:
            switch(whatis) {
                ...
                case '8':
                case '3':
                    t = "Internal Comment: for internal notes only, "
